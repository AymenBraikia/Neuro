...
function header() {
	return (
		<header style={{ display: "flex", justifyContent: "space-around", alignItems: "center", width: "80vw", height: 70, backgroundColor: "var(--background3)", columnGap: "30%", position: "fixed", left: "20vw", zIndex: 5,transition:"var(--transition)" }}>
			<h1>Neuro-3.5</h1>
